...
public class SwaggerConfiguration {
    ...
    public Docket swaggerSpringfoxDocket() {
        Contact contact = new Contact(
                "Студент ПТУ МИРЭА Елшин В.С.",
                "https://www.sas.com/ru_ru/home.html",
                "https://www.sas.com/en_us/contact/form/register.html");

        List<VendorExtension> vext = new ArrayList<>();
        ApiInfo apiInfo = new ApiInfo(
                "Самый лучший веб-сервис на планете",
                "Загадка: Как написать пут метод? На размышление дается стак оверфлоу",
                "Alpha Beta Early Access 0.000001",
                "...",
                contact,
